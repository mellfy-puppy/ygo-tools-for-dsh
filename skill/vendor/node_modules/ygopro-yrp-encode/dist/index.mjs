// src/ygopro-yrp.ts
import YGOProDeck2 from "ygopro-deck-encode";
...
var YGOProYrp = class {
  constructor(init = {}) {
    ...
    if (init.clientDeck) {
      this.clientDeck = new YGOProDeck2({
    ...
    if (init.tagHostDeck) {
      this.tagHostDeck = new YGOProDeck2({
    ...
    if (init.tagClientDeck) {
      this.tagClientDeck = new YGOProDeck2({

...
type Parsed<T, TNoParse extends boolean | undefined> = TNoParse extends true ? undefined : T;
export type OcgcoreCardQueryResult<TNoParse extends boolean | undefined = false> = OcgcoreBinaryResult & {
    card: Parsed<CardQuery | null, TNoParse>;
};
export type OcgcoreFieldCardQueryResult<TNoParse extends boolean | undefined = false> = OcgcoreBinaryResult & {
    cards: Parsed<CardQuery[], TNoParse>;
};
export interface OcgcoreMessageResult extends OcgcoreBinaryResult {
}
export type OcgcoreProcessResult<TNoParse extends boolean | undefined = false> = OcgcoreBinaryResult & {
    status: number;
    messages?: Parsed<YGOProMsgBase[], TNoParse>;
    message?: Parsed<YGOProMsgBase, TNoParse>;
};
export type OcgcoreFieldInfoResult<TNoParse extends boolean | undefined = false> = OcgcoreBinaryResult & {

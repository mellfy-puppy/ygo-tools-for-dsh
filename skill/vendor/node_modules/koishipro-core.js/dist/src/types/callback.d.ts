...
export type MayWithFinalizer<F extends (...args: any[]) => any> = F | WithFinalizer<F>;
export type ScriptReaderFn = (path: string) => string | Uint8Array | null | undefined;
export type CardReaderFn = (cardId: number) => Partial<CardDataEntry> | null | undefined;
export type MessageHandlerFn = (duel: OcgcoreDuel, message: string, type: OcgcoreMessageType) => void;
